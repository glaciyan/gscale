...
<template>
  <div class="rounded-md bg-dark-500 w-[100px]">
    <div :class="['bg-dark-500 aspect-w-1 aspect-h-1', mugshotRounding]">
      <img :class="mugshotRounding" :src="getCharacterImage(normalizedName, 'mugshot').webp" width="100" height="100" />
    </div>
